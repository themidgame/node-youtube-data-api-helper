...
describe('Channel', function () {
  ...
  describe('playlists', function () {
    var youtube = new YouTubeDataAPI(),
      playlists = youtube.channel({ version: 'v3', id: '123' }).playlists;
  ...
  describe('playlists list', function () {
    var youtube = new YouTubeDataAPI(),
      playlists = youtube.channel({ version: 'v3', id: 'UCCjyq_K1Xwfg8Lndy7lKMpA' }).playlists,
